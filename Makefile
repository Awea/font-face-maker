...
fromOTF:
	@$(FONTFORGE) -lang=ff -c 'Open($$1);Generate($$1:r + ".ttf");Generate($$1:r + ".woff");Generate($$1:r + ".woff2")' '$(DEST)/$(FONT_NAME)' '$(DEST)' 'false' 2> /dev/null
	@rm -f $(DEST)/*.afm

fromTTF:
	@$(FONTFORGE) -lang=ff -c 'Open($$1);Generate($$1:r + ".woff");Generate($$1:r + ".woff2")' '$(DEST)/$(FONT_NAME)' '$(DEST)' 'false' 2> /dev/null
	@rm -f $(DEST)/*.afm
